...
export interface ApiBlogPostBlogPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    post_categories: Schema.Attribute.Relation<
      'oneToMany',
      'api::post-categories-app.post-categories-app'
    >;
...
export interface ApiNewsAppNewsApp extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    description: '';
    displayName: 'News';
    pluralName: 'news';
    singularName: 'news-app';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    importance: Schema.Attribute.Enumeration<['morning']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPostCategoriesAppPostCategoriesApp
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::news-app.news-app': ApiNewsAppNewsApp;
      'api::post-categories-app.post-categories-app': ApiPostCategoriesAppPostCategoriesApp;
